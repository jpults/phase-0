...
//
//
// //What tests did you have trouble passing? What did you do to make it pass? Why did that work?  Creating empty objects. I tried to set it to undefined, but later found it should be new Object()
// How difficult was it to add and delete properties outside of the object itself? Not difficult at all.
// What did you learn about manipulating objects in this challenge?  You can easily create nested data strucures using the dot notation on objects.
//
